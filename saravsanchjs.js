...
const response1 = await fetch('./question.json');
const myJson1 = await response1.json();

const response2 = await fetch('./answers.json');
...
// const myJson2 = await import('./answers.json', {
//   assert: { type: 'json' }
// });
...
if (localStorage.getItem("test_number")=="A"){
    var myJson = {
        "1": "28_1",
        "2": "28_2",
        "3": "28_3",
...
else if (localStorage.getItem("test_number")=="B"){
    // var myJson = {
    //     "1": "1_1",
    //     "2": "1_2",
    //     "3": "1_3",
...
else if (localStorage.getItem("test_number")=="C"){
    // var myJson = {
    //     "1": "1_1",
    //     "2": "1_2",
    //     "3": "1_3",
